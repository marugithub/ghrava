...
module.exports = defineConfig({
  ...
  testMatch: ['ghrava-e2e.spec.js', 'smoke.spec.js', 'pending-tab.spec.js', 'forecast-chart.spec.js', 'asterisk-per-record.spec.js', 'trade-mount.spec.js', 'reports-viewers-smoke.spec.js'],
